          ...
          <el-col>
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
              <el-form-item label="用户名称" prop="userName">
                <el-input v-model="queryParams.userName" placeholder="请输入用户名称" clearable style="width: 130px"
                  @keyup.enter="handleQuery" />
              </el-form-item>
              <el-form-item label="用户工号" prop="workNumber">
                <el-input v-model="queryParams.workNumber" placeholder="请输入用户工号" clearable style="width: 130px"
                  @keyup.enter="handleQuery" />
              </el-form-item>
              <el-form-item label="手机号码" prop="phonenumber">
                <el-input v-model="queryParams.phonenumber" placeholder="请输入手机号码" clearable style="width: 130px"
                  @keyup.enter="handleQuery" />
              </el-form-item>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="用户工号" align="center" key="workNumber" prop="workNumber"
                v-if="columns.workNumber.visible" :show-overflow-tooltip="true" />
              <el-table-column label="FIS账号" align="center" key="fisNumber" prop="fisNumber"
                v-if="columns.fisNumber.visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="用户工号" prop="workNumber">
              <el-input v-model="form.workNumber" placeholder="请输入用户工号" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="FIS账号" prop="fisNumber">
              <el-input v-model="form.fisNumber" placeholder="请输入FIS账号" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const columns = ref({
  ...
  workNumber: { label: '用户工号', visible: true },
  fisNumber: { label: 'FIS账号', visible: true },
...
const data = reactive({
  ...
  rules: {
    ...
    workNumber: [{ required: true, message: "用户工号不能为空", trigger: "blur" }, { min: 9, max: 9, message: "用户工号长度必须是9位", trigger: "blur" }],
    fisNumber: [{ required: true, message: "FIS账号不能为空", trigger: "blur" }, { min: 7, max: 7, message: "FIS账号长度必须是7位", trigger: "blur" }],
